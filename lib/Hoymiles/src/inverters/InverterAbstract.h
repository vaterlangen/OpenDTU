...
typedef struct {
    ...
    std::vector<ChannelNum_t> channels; // channel 0 - 5
} mpptAssign_t;
...
public:
    ...
    virtual const mpptAssign_t* getMpptAssignment() const = 0;
    virtual uint8_t getMpptAssignmentSize() const = 0;
