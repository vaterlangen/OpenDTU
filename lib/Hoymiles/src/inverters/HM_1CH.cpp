...
static const byteAssign_t byteAssignment[] = {
    ...
    { TYPE_DC, CH0, MPPT_A, FLD_YD, UNIT_WH, 12, 2, 1, false, 0 },
    { TYPE_DC, CH0, MPPT_A, FLD_YT, UNIT_KWH, 8, 4, 1000, false, 3 },
    { TYPE_DC, CH0, MPPT_A, FLD_IRR, UNIT_PCT, CALC_CH_IRR, CH0, CMD_CALC, false, 3 },

    { TYPE_AC, CH0, MPPT_NONE, FLD_UAC, UNIT_V, 14, 2, 10, false, 1 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_IAC, UNIT_A, 22, 2, 100, false, 2 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_PAC, UNIT_W, 18, 2, 10, false, 1 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_Q, UNIT_VAR, 20, 2, 10, false, 1 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_F, UNIT_HZ, 16, 2, 100, false, 2 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_PF, UNIT_NONE, 24, 2, 1000, false, 3 },

    { TYPE_INV, CH0, MPPT_NONE, FLD_T, UNIT_C, 26, 2, 10, true, 1 },
    { TYPE_INV, CH0, MPPT_NONE, FLD_EVT_LOG, UNIT_NONE, 28, 2, 1, false, 0 },
