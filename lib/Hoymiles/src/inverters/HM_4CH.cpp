...
static const byteAssign_t byteAssignment[] = {
    ...
    { TYPE_DC, CH1, MPPT_A, FLD_UDC, UNIT_V, CALC_CH_UDC, CH0, CMD_CALC, false, 1 },
    ...
    { TYPE_DC, CH3, MPPT_B, FLD_UDC, UNIT_V, CALC_CH_UDC, CH2, CMD_CALC, false, 1 },
    ...
    { TYPE_AC, CH0, MPPT_NONE, FLD_UAC, UNIT_V, 46, 2, 10, false, 1 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_IAC, UNIT_A, 54, 2, 100, false, 2 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_PAC, UNIT_W, 50, 2, 10, false, 1 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_Q, UNIT_VAR, 52, 2, 10, false, 1 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_F, UNIT_HZ, 48, 2, 100, false, 2 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_PF, UNIT_NONE, 56, 2, 1000, false, 3 },

    { TYPE_INV, CH0, MPPT_NONE, FLD_T, UNIT_C, 58, 2, 10, true, 1 },
    { TYPE_INV, CH0, MPPT_NONE, FLD_EVT_LOG, UNIT_NONE, 60, 2, 1, false, 0 },
