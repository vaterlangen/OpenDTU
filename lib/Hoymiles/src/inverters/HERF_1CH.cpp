...
static const byteAssign_t byteAssignment[] = {
    ...
    { TYPE_AC, CH0, MPPT_NONE, FLD_Q, UNIT_VAR, 40, 2, 10, false, 1 }, // to be verified
    { TYPE_AC, CH0, MPPT_NONE, FLD_F, UNIT_HZ, 28, 2, 100, false, 2 },
    { TYPE_AC, CH0, MPPT_NONE, FLD_PF, UNIT_NONE, 36, 2, 1000, false, 3 },

    { TYPE_INV, CH0, MPPT_NONE, FLD_T, UNIT_C, 38, 2, 10, true, 1 }, // to be verified
    { TYPE_INV, CH0, MPPT_NONE, FLD_EVT_LOG, UNIT_NONE, 40, 2, 1, false, 0 }, // to be verified
